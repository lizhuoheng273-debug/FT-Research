...
export function AIHotFeed({ topics, items, loading = false, onOpenStory }: Props) {
  ...
  return <>
    ...
    <div className="mb-3 flex items-baseline justify-between"><h2 className="text-lg font-semibold">精选事件</h2><span className="text-xs text-muted-foreground">共 {topics.length} 条</span></div>
